...
public class UserResource {
	...
	@GetMapping  //informando que é uma requisição do tipo get
	 public ResponseEntity<List <Usuario>> findAll(){ //retorna uma lista de usuarios
	...
	public ResponseEntity<Usuario> findById(@PathVariable Long id){ //retorna um unico usuario
