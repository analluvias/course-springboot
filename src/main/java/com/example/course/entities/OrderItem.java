...
public class OrderItem implements Serializable{
	...
	public OrderItem(Order order, Product product, Integer quantity, Double price) {
		super();
		id.setOrder(order); //setando o pedido na classe que é a pk composta
		id.setProduct(product);//setando o produto na classe que é a pk composta
	...
	//sempre que quisermos que um método apareça no json ou xml, começamos seu nome com get
